...
addpath('../Features');
addpath('../Experiments');
load ../Saved_Models/model_31_40_removed_SVM_chg_nor.mat
...
audition_metadata1 = scanFBA(fba_relative_path, ...
    band_option, ...
    instrument_option, ...
    segment_option, ...
    score_option, ...
...
[file_feature_vector,classification_vector_file] = computeFeaturesForFile(audition_metadata1, 4096, 2048, 6);
