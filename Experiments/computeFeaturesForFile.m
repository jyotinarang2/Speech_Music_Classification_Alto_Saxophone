...
%file acts as a test file for testing the fetaure accuracy.
function [final_feature_vector,classification_vector] = computeFeaturesForFile(audition_metadata, iBlockLength, iHopLength,file_number)
%file_number = 51;
